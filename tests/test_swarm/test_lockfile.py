...
from daoyi.swarm import lockfile
from daoyi.utils import file_lock
...
def test_exclusive_file_lock_routes_windows_branch(monkeypatch, tmp_path: Path):
    ...
    # The implementation lives in ``daoyi.utils.file_lock``;
    # ``daoyi.swarm.lockfile`` re-exports it for backwards compatibility.
