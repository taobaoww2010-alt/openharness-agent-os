...
from daoyi.config.settings import PathRuleConfig, PermissionSettings
from daoyi.permissions import PermissionChecker, PermissionMode
from daoyi.permissions.checker import SENSITIVE_PATH_PATTERNS
...
def test_invalid_pattern_rule_is_skipped_and_warns(bad_rule, caplog):
    ...
    with caplog.at_level(logging.WARNING, logger="daoyi.permissions.checker"):
...
class TestSensitivePathProtection:
    ...
    def test_full_auto_blocks_sensitive_paths(self):
        ...
        for path in (
            ...
            "/home/user/.daoyi/credentials.json",
            "/home/user/.daoyi/copilot_auth.json",
        ):
    ...
    def test_every_builtin_pattern_has_coverage(self, pattern):
        ...
        example_paths = {
            ...
            "*/.daoyi/credentials.json": "/home/u/.daoyi/credentials.json",
            "*/.daoyi/copilot_auth.json": "/home/u/.daoyi/copilot_auth.json",
        }
