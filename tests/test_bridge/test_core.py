...
from daoyi.bridge import WorkSecret, build_sdk_url, decode_work_secret, encode_work_secret, spawn_session
...
async def test_spawn_session_merges_stderr_into_stdout(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr(
        "daoyi.bridge.session_runner.create_shell_subprocess",
