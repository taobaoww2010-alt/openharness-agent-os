        ...
        if not model or not api_key:
            ...
            return ToolResult(
                output=(
                    ...
                    "or configure the DAOYI_VISION_MODEL and "
                    "DAOYI_VISION_API_KEY environment variables."
                ),
                is_error=True,
            )
    ...
    async def _call_vision_model(
        *,
        ...
        async for event in client.stream_message(
            ...
            from daoyi.api.client import ApiTextDeltaEvent, ApiMessageCompleteEvent
