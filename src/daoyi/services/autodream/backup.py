...
from daoyi.config.paths import get_data_dir


def default_backup_root(memory_dir: str | Path, *, app_label: str = "daoyi") -> Path:
    ...
    return get_data_dir() / "memory-backups" / (safe_label or "daoyi")
...
def latest_memory_backup(memory_dir: str | Path, *, app_label: str = "daoyi") -> Path | None:
