...
_EMPTY_REASONING_ENV = "DAOYI_REQUIRE_EMPTY_REASONING_CONTENT"
...
def _convert_assistant_message(msg: ConversationMessage) -> dict[str, Any]:
    ...
    - When there is no captured reasoning but the message has tool calls,
      ...
      ``DAOYI_REQUIRE_EMPTY_REASONING_CONTENT=1``. The default is
...
class OpenAICompatibleClient:
    ...
    async def _stream_once(self, request: ApiMessageRequest) -> AsyncIterator[ApiStreamEvent]:
        ...
        async for chunk in stream:
            ...
            # Accumulate reasoning_content from thinking models and yield to frontend
