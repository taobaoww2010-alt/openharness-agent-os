...
from daoyi.engine.messages import ConversationMessage, assistant_message_from_api
...
class ApiThinkingDeltaEvent:
    """Incremental thinking/reasoning content produced by the model."""
...
def _translate_api_error(exc: APIError) -> DaoYiApiError:
