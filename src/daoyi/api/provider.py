...
from daoyi.auth.external import describe_external_binding
from daoyi.auth.storage import load_external_binding
from daoyi.api.registry import detect_provider_from_registry
...
def auth_status(settings: Settings) -> str:
    ...
    if settings.api_format == "copilot":
        from daoyi.api.copilot_auth import load_copilot_auth
