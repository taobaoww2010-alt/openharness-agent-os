...
from daoyi.api.client import ApiMessageCompleteEvent, ApiMessageRequest, SupportsStreamingMessages
...
from daoyi.hooks.types import AggregatedHookResult, HookResult
    ...
    async def _run_command_hook(
        ...
        try:
            process = await create_shell_subprocess(
                ...
                env={
                    **os.environ,
                    "DAOYI_HOOK_EVENT": event.value,
                    "OPENHARNESS_HOOK_EVENT": event.value,
                    "DAOYI_HOOK_PAYLOAD": json.dumps(payload),
