...
class ApiKeyFlow(AuthFlow):
    """Prompt the user for an API key and persist it via :mod:`daoyi.auth.storage`."""
...
class DeviceCodeFlow(AuthFlow):
    ...
    def __init__(
        ...
        *,
        ...
        from daoyi.api.copilot_auth import COPILOT_CLIENT_ID
    ...
    def run(self) -> str:
        from daoyi.api.copilot_auth import poll_for_access_token, request_device_code
