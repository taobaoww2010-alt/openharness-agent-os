...
from daoyi.config import Settings
from daoyi.platforms import get_platform, get_platform_capabilities
from daoyi.sandbox.adapter import SandboxAvailability, SandboxUnavailableError
...
class DockerSandboxSession:
    ...
    def __post_init__(self) -> None:
        self._container_name = f"daoyi-sandbox-{self.session_id}"
