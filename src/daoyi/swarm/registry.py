...
from daoyi.platforms import get_platform, get_platform_capabilities
from daoyi.swarm.spawn_utils import is_tmux_available
from daoyi.swarm.types import BackendDetectionResult, BackendType, TeammateExecutor
...
class BackendRegistry:
    ...
    def get_executor(self, backend: BackendType | None = None) -> TeammateExecutor:
        ...
        Returns:
            The registered :class:`~daoyi.swarm.types.TeammateExecutor`.
    ...
    def get_preferred_backend(self, config: dict | None = None) -> BackendType:
        ...
        if config:
            ...
            mode = os.environ.get("DAOYI_TEAMMATE_MODE") or os.environ.get("OPENHARNESS_TEAMMATE_MODE") or "auto"
    ...
    def _register_defaults(self) -> None:
        ...
        if get_platform_capabilities().supports_swarm_mailbox:
            from daoyi.swarm.in_process import InProcessBackend
