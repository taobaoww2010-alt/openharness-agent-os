...
Paths:
    ~/.daoyi/teams/<teamName>/permissions/pending/<id>.json
    ~/.daoyi/teams/<teamName>/permissions/resolved/<id>.json
"""
...
from daoyi.swarm.lockfile import exclusive_file_lock
...
def get_permission_dir(team_name: str) -> Path:
    """Return ~/.daoyi/teams/{teamName}/permissions/"""
...
async def get_leader_name(team_name: str | None = None) -> str | None:
    ...
    """
    from daoyi.swarm.team_lifecycle import read_team_file_async
...
async def handle_permission_request(
    ...
    Args:
        ...
        checker: An already-configured :class:`~daoyi.permissions.checker.PermissionChecker`.
