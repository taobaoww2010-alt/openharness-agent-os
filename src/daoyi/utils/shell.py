...
from daoyi.config import Settings, load_settings
from daoyi.platforms import PlatformName, get_platform
from daoyi.sandbox import wrap_command_for_sandbox
...
async def create_shell_subprocess(
    ...
    *,
    ...
    if resolved_settings.sandbox.enabled and resolved_settings.sandbox.backend == "docker":
        from daoyi.sandbox.session import get_docker_sandbox
