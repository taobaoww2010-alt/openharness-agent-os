...
async def run_task_worker(
    *,
    ...
    async def _render_event(event: StreamEvent) -> None:
        from daoyi.engine.stream_events import AssistantTextDelta, AssistantTurnComplete, ErrorEvent, StatusEvent, ThinkingDelta
