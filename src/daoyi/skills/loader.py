...
from daoyi.skills._frontmatter import (
...
_DEFAULT_PROJECT_SKILL_DIRS = (".daoyi/skills", ".agents/skills", ".claude/skills")


def get_user_skills_dir() -> Path:
    """Return the DaoYi Agent OS user skills directory."""
